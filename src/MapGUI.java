...
public class MapGUI extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		Map = new MapDrawer(this.guiMap.getTablePOIs(), LocationTextInput,
				DestinationTextInput, waypointTextInput);
		...
		TitleLayout.setHorizontalGroup(TitleLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				TitleLayout.createSequentialGroup().addGap(158, 158, 158)
						.addComponent(TitleText)
						.addContainerGap(167, Short.MAX_VALUE)));
		TitleLayout.setVerticalGroup(TitleLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				TitleLayout
		...
		javax.swing.GroupLayout NavigationLayout = new javax.swing.GroupLayout(
				Navigation);
		Navigation.setLayout(NavigationLayout);
		NavigationLayout
				.setHorizontalGroup(NavigationLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								NavigationLayout
		...
		NavigationLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { DestinationLabel, GetResultByTime,
						LocationLabel });

		NavigationLayout
				.setVerticalGroup(NavigationLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								NavigationLayout
	...
	private void FindRouteButtonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (!DestinationTextInput.getText().equals("")
				&& !LocationTextInput.getText().equals("")
			...
			if (MapGUI.this.guiMap.getTablePOIs().get(to) != null
				...
				for (String n : MapGUI.this.guiMap.getTablePOIs().keySet()) {
					...
					MapGUI.this.guiMap.getTablePOIs().get(n).straightLineDist = MapGUI.this.guiMap
							.getTablePOIs()
							.get(n)
							.DistToNeighbor(
									MapGUI.this.guiMap.getTablePOIs().get(to));
				}
			}
			...
			if (this.displayDistance) {
				...
				TravelDistTime.setText("Travel Time: " + hoursDisplay + " hr "
						+ minutes + " min");
			}
		...
		} else if (DestinationTextInput.getText().equals("")
				&& !LocationTextInput.getText().equals("")) {
	...
	private void AddWaypointButtonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (!DestinationTextInput.getText().equals("")
				&& !LocationTextInput.getText().equals("")
				&& !waypointTextInput.getText().equals("")
				&& !waypointTextInput.getText().equals("waypoint")
				&& !DestinationTextInput.getText().equals("choose a place")
				&& !LocationTextInput.getText().equals("choose a place")) {
			...
			if (MapGUI.this.guiMap.getTablePOIs().get(waypoint) != null
				...
				for (String n : MapGUI.this.guiMap.getTablePOIs().keySet()) {
					...
					MapGUI.this.guiMap.getTablePOIs().get(n).straightLineDist = MapGUI.this.guiMap
							...
							.get(n)
							.DistToNeighbor(
									MapGUI.this.guiMap.getTablePOIs().get(
											waypoint));
				}
			}

			LinkedList<Map.PointofInterest> path1 = this.guiMap.navigate(
					waypoint, from);
			...
			this.guiMap.navigationDist = 0;
			LinkedList<Map.PointofInterest> path2 = this.guiMap.navigate(to,
					waypoint);
	...
	private void SearchByRatingButtonActionPerformed(
