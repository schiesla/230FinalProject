...
public class MapGUI extends javax.swing.JFrame {
	...
	private void initComponents() {
        ...
        MapLayout.setHorizontalGroup(
            ...
            .addGroup(MapLayout.createSequentialGroup()
                ...
                .addGroup(MapLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(ratingTextInput, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(SearchByRatingButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(AddWaypointButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, MapLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(waypointTextInput))
                .addContainerGap())
        );
        MapLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, MapLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(AddWaypointButton, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(13, 13, 13)
                .addComponent(ratingTextInput, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
	...
	private void AddWaypointButtonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (!DestinationTextInput.getText().equals("") && !LocationTextInput.getText().equals("")
				&&  !waypointTextInput.getText().equals("") && !waypointTextInput.getText().equals("waypoint") && !DestinationTextInput.getText().equals("choose a place")
				&& !LocationTextInput.getText().equals("choose a place")) {
	...
	private void SearchByRatingButtonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		// ArrayList<Map.PointofInterest> results =
		// this.guiMap.searchByRating(rating);
		//
