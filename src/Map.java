...
public class Map {
	...
	/**
	 * 
	 * Class that creates points of interest for all the places stored in the
	 * text files
	 *
	...
	/**
	 * 
	 * Points of interest have a list of connections which are the neighboring
	 * cities and the distance to them.
	 *
	 * @author schiesla. Created Feb 21, 2016.
	 */
